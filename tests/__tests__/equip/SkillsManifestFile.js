    ...
    describe('should keep property', () => {
      describe('#filePath', () => {
        const cases = [
          {
            input: {
              filePath: '/tmp/app/.hora/hora-skills-ort-core.json',
              installationPath: '.claude/skills',
            },
            expected: '/tmp/app/.hora/hora-skills-ort-core.json',
          },
          {
            input: {
            ...
            expected: '.hora/hora-skills-ort-core.json',
          },
        ]
  ...
  describe('#load()', () => {
    describe('should parse the manifest', () => {
      const cases = [
        {
          override: {
            content: '{"version":"0.0.1","installations":{".claude/skills":{"skillNames":["hoc-query-resolver"]}}}',
          },
          expected: {
            version: '0.0.1',
            installations: {
      ...
      const cases = [
        {
          ...
          expected: [
            '/tmp/app/.hora/hora-skills-ort-core.json',
            '{\n  "version": "0.0.1",\n  "installations": {\n    ".claude/skills": {\n      "skillNames": [\n        "hoc-query-resolver"\n      ]\n    }\n  }\n}\n',
          ],
        },
        {
