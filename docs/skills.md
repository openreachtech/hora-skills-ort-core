...
| `hoc-workflows` | Development workflow rules — how to proceed with an implementation, which to follow where a convention and the surrounding code disagree, and the steps always performed before committing and before completion. |
